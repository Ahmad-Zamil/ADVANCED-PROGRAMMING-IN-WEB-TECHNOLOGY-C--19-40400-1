        ...
        <div style={{ marginBottom: "57px" }}>
            <nav className="navbar navbar-expand-lg  navbar-light fixed-top" style={{ background: "darkblue" }}>
                <div className="container-fluid container">
                    <h3 className="text-white">ONLINE PHARMACY</h3>
                    <div className="navbar-nav font-weight-bold ms-auto">
                        ...
                        <Dropdown >
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item href="/television"><span className='fw-bold text-uppercase text-danger'>A</span></Dropdown.Item>
                                <Dropdown.Item href="/camera"><span className='fw-bold text-uppercase text-danger'>B</span></Dropdown.Item>
                                <Dropdown.Item href="/laptop"><span className='fw-bold text-uppercase text-danger'>C</span></Dropdown.Item>
                                <Dropdown.Item href="/phone"><span className='fw-bold text-uppercase text-danger'>D</span></Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
