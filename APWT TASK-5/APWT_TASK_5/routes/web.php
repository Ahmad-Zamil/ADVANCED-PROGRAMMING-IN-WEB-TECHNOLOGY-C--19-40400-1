...
//SellsMan
Route::get('/sells_manList', [sells_manController::class, 'sells_manList'])->name('sells_manList');//->middleware('ValidAdmin');
...
Route::get('/delivarymanList', [delivarymanController::class, 'delivarymanList'])->name('delivarymanList')->middleware('ValidAdmin');
